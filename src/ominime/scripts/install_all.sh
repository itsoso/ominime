...
echo "║   3. ⏰ 每日导出 (23:30 自动导出到 Obsidian)             ║"
echo "║                                                          ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo -e "${NC}"

echo ""
echo -e "${CYAN}[1/3] 安装主应用服务...${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
"$SCRIPT_DIR/install_app.sh"

echo ""
echo -e "${CYAN}[2/3] 安装 Web 服务...${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
"$SCRIPT_DIR/install_web.sh"

echo ""
echo -e "${CYAN}[3/3] 安装每日导出定时任务...${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
"$SCRIPT_DIR/install_daily_export.sh"
...
echo -e "${GREEN}║   ⏰ 每日导出: 每天 23:30 自动导出到 Obsidian            ║${NC}"
echo -e "${GREEN}║                                                          ║${NC}"
